...
import { Avatar, Badge, Col, Row, Tag } from 'antd';
...
export const gridOrderStatus = (props) => (
  ...
  <div>
    <Tag color={props.StatusBg}>{props.Status}</Tag>
  </div>
);
...
const customerGridStatus = (props) => (
  <Badge color={props.StatusBg} text={props.Status} />
);
...
export const employeesGrid = [
...

  {
    ...
    width: '120',
    textAlign: 'Center',
    sorting: (a, b)=> a.ReportsTo.localeCompare(b.ReportsTo)
  },
  {
    field: 'EmployeeID',
    ...
    textAlign: 'Center',
    inputType: 'number',
    sorting: (a, b)=> a.EmployeeID - b.EmployeeID
  },
];
...
export const ordersGrid = [
  ...
  },
  {
    ...
    textAlign: 'Center',
    sorting: (a, b)=> a.OrderItems.localeCompare(b.OrderItems)
  },
  {
    field: 'CustomerName',
    ...
    width: '150',
    textAlign: 'Center',
    sorting: (a, b)=> a.CustomerName.localeCompare(b.CustomerName)
  },
  {
    field: 'TotalAmount',
    ...
    width: '150',
    sorting: (a, b)=> a.TotalAmount - b.TotalAmount
  },
  {
    headerText: 'Status',
    ...
    textAlign: 'Center',
    width: '120',
    sorting: (a, b)=> a.Status.localeCompare(b.Status)
  },
  {
    field: 'OrderID',
    headerText: 'Order ID',
    width: '120',
    textAlign: 'Center',
    sorting: (a, b)=> a.OrderID - b.OrderID
  },

  {
    ...
    width: '150',
    textAlign: 'Center',
    sorting: (a, b)=> a.Location.localeCompare(b.Location)
